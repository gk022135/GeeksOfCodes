  ...
  return (
    <>
      ...
      <div className="fixed bottom-2 left-1/2 -translate-x-1/2 z-50 md:hidden flex flex-row items-center justify-between bg-base-100 backdrop-blur-xl border border-gray-200/50 rounded-3xl shadow-2xl px-4 py-2 w-[95%] max-w-3xl">
        {/* Nav Buttons */}
        {[
          { icon: <House color="gray" size={24} />, label: "Home", key: "/" },
          { icon: <LayoutGrid color="gray" size={24} />, label: "Categories", key: "/user-home" },
          { icon: <Mail color="gray" size={24} />, label: "Messages", key: "/discussion" },
          { icon: <Search color="gray" size={24} />, label: "Search", key: "/search" },
          { icon: <Bell color="gray" size={24} />, label: "Notifications", key: "/noti" },
          { icon: <Plus color="white" size={24} />, label: "Add New", key: "/posts", className: "bg-amber-500" },
